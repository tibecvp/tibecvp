...
# 👋 Hi, I'm Tiberio
### Software Engineer | 9+ Years in QA | Quality-Driven Web Developer

I’m a multilingual Software Engineer with a strong foundation in Software Quality Assurance and expanding expertise in front-end and full-stack web development.
My background in QA gives me a quality-first mindset, and my recent postgraduate studies in Full-Stack Software Development strengthen my path toward automation, modern frontend development, and technical problem-solving.

I enjoy building clean, reliable, user-centric applications — and improving them through solid testing practices.

## 🚀 Tech Focus
- JavaScript, React, Vue.js
- HTML5, CSS3, Tailwind
- Node.js & REST APIs
- Cypress, BackstopJS, Postman
- Git/GitHub | Agile | CI basics
...
## 🎯 What I’m Working On
- Expanding automation skills (Cypress + best testing practices)
- Strengthening React and Vue.js projects
- Contributing to open-source when possible
- Building a portfolio aligned with QA + Dev opportunities
